...
public class CreateGenreControllerTest(InfraIntegrationTestsFixture fixture)
{
    [Fact]
    public async Task CreateGenre_Create_ShouldBeCreatedSuccessfully()
    {
        // Arrange
    ...
    [Fact]
    public async Task CreateGenre_Create_ShouldBeReturnErrorWhenValidationFails()
    {
        // Arrange
        var requestUri = $"/api/v1/genres";
        var json = $@"{{
